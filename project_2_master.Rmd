...
Overall, if our goal is to identify those students who are in desperate need of help (Low students), we will want to pick the model that best predicts those students who are low and are predicted low at a high rate, but more importantly having a low rate of students who are predicted high who are low. Right away, we can tell that it is between our LASSO and our PCAmix models to use as our final model as LDA had a lower overall and precision accuracy compared to the other two. 

So between our LASSO and PCAmix models. Looking at both, they each have very different recall percentages indicating that one correctly predicts a low student at a better rate. While our LASSO model has a higher precision score of 89.47% as compared to our PCAmix model, meaning that it didn't predict so many high students as low students. While this is not a major issue as those who are high being identified as low will only give them more help to do better, it is still important to look at. But our biggest concern is looking at our recall percentage as we do not want to identify low students as high as they will not receive the needed help. With that, our best model would be our PCAmix model as it blows LASSO and LDA out with an extremely high value of 89.5%

In conclusion, our final chosen model is the PCAmix model, as it maintains a better recall value than the LASSO model and LDA model. In addition, this model will give us the best chance at identifying low students correctly, provides very few false negatives (predicted high but is low), and still provides a serviceable precision score. 
